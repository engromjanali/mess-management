...
class FundFilterBar extends StatelessWidget {
  const FundFilterBar({required this.dateFilter, required this.selectedDate, required this.selectedRange, super.key});
  ...
  Future<void> _pickRange(BuildContext context) async {
    ...
    if (picked != null && context.mounted) {
      _bloc(context).add(FundEvent.selectRange(start: picked.start, end: picked.end));
    }
  }
