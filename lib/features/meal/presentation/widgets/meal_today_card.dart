...
class MealTodayCard extends StatelessWidget {
  const MealTodayCard({required this.today, required this.mealRate, required this.onChanged, this.editable = true, super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Divider(height: Dimensions.paddingSizeLarge),
          _MealRow(icon: Icons.dinner_dining_rounded, label: 'Dinner', accent: colors.infoColor, value: today.dinner, editable: editable, onChanged: (v) => onChanged(today.breakfast, today.lunch, v)),
          const SizedBox(height: Dimensions.paddingSizeLarge),
          Container(
...
class _MealRow extends StatelessWidget {
  const _MealRow({required this.icon, required this.label, required this.accent, required this.value, required this.editable, required this.onChanged});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        if (editable) MealStepper(value: value, onChanged: onChanged, accent: accent) else _ReadOnlyValue(value: value, accent: accent),
      ],
    );
  }
}
